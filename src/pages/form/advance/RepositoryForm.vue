            ...
            <a-col :lg="6" :md="12" :sm="24">
                <a-form-item :label="$t('approval')">
                    ...
                    >
                        ...
                        <a-select-option value="谢文东">谢文东</a-select-option>
                        <a-select-option value="秋凝水">秋凝水</a-select-option>
                        <a-select-option value="李晓云">李晓云</a-select-option>
                    </a-select>
                </a-form-item>
            </a-col>
            <a-col :xl="{span: 6, offset: 2}" :lg="{span: 8}" :md="{span: 12}" :sm="24">
            ...
            <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
                <a-form-item :label="$t('type')">
                    ...
                    >
                        ...
                        <a-select-option value="部分公开">部分公开</a-select-option>
                    </a-select>
                </a-form-item>
            </a-col>
        </a-row>
