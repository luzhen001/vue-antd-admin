            ...
            <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
                <a-form-item :label="$t('executor')">
                    ...
                    >
                        ...
                        <a-select-option value="东方彧卿">东方彧卿</a-select-option>
                        <a-select-option value="唐寅">唐寅</a-select-option>
                        <a-select-option value="韩非">韩非</a-select-option>
                    </a-select>
                </a-form-item>
            </a-col>
        </a-row>
        <a-row class="form-row">
            <a-col :lg="6" :md="12" :sm="24">
                <a-form-item :label="$t('duty')">
                    ...
                    >
                        <a-select-option value="向问天">向问天</a-select-option>
            ...
            <a-col :xl="{span: 6, offset: 2}" :lg="{span: 8}" :md="{span: 12}" :sm="24">
                <a-form-item :label="$t('time')">
                    <a-time-picker
                        v-decorator="['task.time', {rules: [{ required: true, message: $ta('select|time')}]}]" style="width: 100%"
                    />
                </a-form-item>
            </a-col>
            <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
